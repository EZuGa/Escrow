...
user_urls = [
    ...
    path(f"reset_password_code/", UserGetResetPasswordCodeAPI.as_view(), name="user-get-reset-password-code"),
    path(f"reset_password/", UserResetPasswordAPI.as_view(), name="user-reset-password"),
